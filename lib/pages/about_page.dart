          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('- iOS Version', style: TextStyle(fontSize: 15, color: isDark ? Colors.grey[300] : Colors.black87)),
                  Text('- More social media sites',
                      style: TextStyle(fontSize: 15, color: isDark ? Colors.grey[300] : Colors.black87)),
                  Text('- More category icons', style: TextStyle(fontSize: 15, color: isDark ? Colors.grey[300] : Colors.black87)),
                  Text(
