...
class TwitterPage extends StatelessWidget {
  ...
  void _showAddIconDialog(BuildContext context, TwitterController controller) {
    final theme = Theme.of(context);
    final isDark = theme.brightness == Brightness.dark;
    final nameController = TextEditingController();
    final List<Map<String, String>> availableIcons = [
      // Platform Icons (without 'Add' first)
  ...
  void _showRenameCategoryDialog(BuildContext context, TwitterController controller,
