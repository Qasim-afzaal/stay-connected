...
class TikTokPage extends StatelessWidget {
  ...
  void _showAddIconDialog(BuildContext context, TikTokController controller) {
  ...
  void _showIconOptions(
      BuildContext context, TikTokController controller, int index) {
