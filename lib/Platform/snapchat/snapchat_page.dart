...
class SnapchatPage extends StatelessWidget {
  SnapchatPage({Key? key}) : super(key: key);
  ...
  void _showAddIconDialog(BuildContext context, SnapchatController controller) {
  ...
  void _showIconOptions(
      BuildContext context, SnapchatController controller, int index) {
  ...
  void _showRenameDialog(BuildContext context, SnapchatController controller,
